  ...
  return (
    <div className="mt-4">
      ...
      <div
        ...
        className="cursor-pointer min-h-32 rounded-xl border-2 border-violet-200 bg-violet-50 p-5 flex flex-col items-center justify-center text-center select-none transition-all hover:border-violet-400"
      >
    ...
    <div className="p-8 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-slate-500 text-sm mt-0.5">
          Upload PDFs — Claude will summarise them and generate flashcards automatically.
        </p>
      </div>
      ...
      <div
        ...
        className={`border-2 border-dashed rounded-2xl p-10 flex flex-col items-center justify-center cursor-pointer transition-colors mb-8 ${
      ...
      <p className="text-center text-xs text-slate-300 mt-10">
        Powered by Claude Haiku 4.5 · Summaries generated by Anthropic AI
      </p>
    </div>
  );
}
